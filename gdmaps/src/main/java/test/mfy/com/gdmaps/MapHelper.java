                ...
                if (aMapLocation != null) {
                    if (aMapLocation.getErrorCode() == 0) {
                        ...
                        if (isFirstLoc) {
                            ...
                            MConstant.latitude = aMapLocation.getLatitude();
                            MConstant.longitude = aMapLocation.getLongitude();
                            MConstant.CITY=aMapLocation.getCity();
                            isFirstIn = true;
                            isFirstLoc = false;
//                            initData();
...
//                    int taxiCost = (int) mDriveRouteResult.getTaxiCost();
    ...
    public void searchRouteResult(int routeType, int mode, LatLonPoint mEndPoint) {
        LatLonPoint mStartPoint = new LatLonPoint(MConstant.latitude, MConstant.longitude);//起点，39.942295,116.335891
        if (mStartPoint == null) {
     ...
     * @param alongitude
     */
    public void startAMapNavigational(NearBuildBeans.DataBean commentData, double alatitude, double alongitude) {
        com.amap.api.maps.model.LatLng startLatLng = new com.amap.api.maps.model.LatLng(alatitude, alongitude);
        com.amap.api.maps.model.LatLng endLatLng = new com.amap.api.maps.model.LatLng(commentData.getLatiude(), commentData.getLongitude());
